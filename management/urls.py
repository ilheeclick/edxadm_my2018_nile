...
urlpatterns = [
    ...
    url(r'^series_course_list_view/(?P<id>.*?)/(?P<name>.*?)/$', views.series_course_list_view, name='series_course_list_view'),
    ...
    url(r'^tracking_log/size/', tracking_view.second_check),
    url(r'^tracking_log/logdata_add/', tracking_view.data_insert),
    url(r'^tracking_log/downlist/', tracking_view.log_board, name='log_board'),
