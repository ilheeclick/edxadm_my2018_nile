...
function setDataTable1() {
    ...
    $table.dataTable({
        ...
        "columnDefs": [
            ...
            {targets: 8, render: function(data) {return '<div style ="width:110px">'+data+'</div>'}},
            {targets: 9, render: function(data) {return '<div style ="width:110px">'+data+'</div>'}},
            {targets: 10, render: function(data) {return '<div style ="width:110px">'+data+'</div>'}},
            {targets: 11, render: function(data) {return '<div style ="width:110px">'+data+'</div>'}},
            {targets: 12, render: function(data) {return '<div style ="width:110px">'+data+'</div>'}},
            {targets: 13, render: function(data) {return '<div style ="width:110px">'+data+'</div>'}},
            {targets: 14, render: function(data) {return '<div style ="width:110px">'+data+'</div>'}},
            {targets: 15, render: function(data) {return '<div style ="width:110px">'+data+'</div>'}},
            {targets: 16, render: function(data) {return '<div style ="width:110px">'+data+'</div>'}},
            {targets: 17, render: function(data) {return '<div style ="width:110px">'+data+'</div>'}},
            {targets: 18, render: function(data) {return '<div style ="width:110px">'+data+'</div>'}},
            {targets: 19, render: function(data) {return '<div style ="width:110px">'+data+'</div>'}},
        ],
